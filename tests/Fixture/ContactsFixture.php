...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'textarea' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-03-24 00:04:05',
                'modified' => '2020-03-24 00:04:05',
            ],
        ];
        parent::init();
    }
