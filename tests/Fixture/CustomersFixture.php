...
class CustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tel' => ['type' => 'string', 'length' => 16, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-04-07 23:57:00',
                'modified' => '2020-04-07 23:57:00',
            ],
        ];
        parent::init();
    }
